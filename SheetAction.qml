...
// oShelf-style icon action: transparent idle, foreground tint on hover,
...
Rectangle {
  ...
  Row {
    ...
    SheetGlyph { visible: !!root.icon; kind: root.icon; width: root.icon ? 20 : 0; height: 20; ink: root.selected ? Color.accent : Color.foreground }
    Text {
      id: caption
      visible: root.label !== ""
